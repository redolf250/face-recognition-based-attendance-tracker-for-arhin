...
################################################################################
## Form generated from reading UI file 'mailbErsFJ.ui'
##
...
"}")
        ...
        self.label_36.setStyleSheet(u"background-color: rgb(66, 66, 66);")
        ...
        self.label_37.setStyleSheet(u"background-color: rgb(66, 66, 66);")
...
"}")
        ...
        self.label_38.setStyleSheet(u"background-color: rgb(66, 66, 66);")
        ...
        self.label_39.setStyleSheet(u"background-color: rgb(66, 66, 66);")
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/icons/asset/send.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, Mail):
        ...
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("Mail", u"Mail", None))
        ...
        self.reg_email.setPlaceholderText(QCoreApplication.translate("Mail", u"Recipient(s) ", None))
        ...
        self.rep_name.setPlaceholderText(QCoreApplication.translate("Mail", u"Recipient", None))
    # retranslateUi
