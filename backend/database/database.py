    ...
    def create_table(self):
        ...
        try:
            if self.ui.add_program.text():
                table_name = "tb_"+data
                cursor.execute(f"CREATE TABLE IF NOT EXISTS {table_name} (generated_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,reference TEXT,fullname TEXT, contact TEXT,date_stamp TEXT, time_stamp TEXT,attendance_status TEXT,date_stamp_ TEXT,position TEXT)")
                db.commit()
